...
namespace TicTacToe
{
    ...
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            ControleurTICTACTOE monJeu = new ControleurTICTACTOE(nomJoueur1, nomJoueur2);
            ...
            while (!monJeu.IsTermine())
            {
                ...
                if (IsPaire(monJeu.CompteurTour)) //Si tour du joueur 2...
                {
        ...
        {
            Console.WriteLine("------------------------------------------------------");
            Console.WriteLine("Bienvenue au jeu TIC TAC TOE !!!");
            Console.WriteLine("------------------------------------------------------");
        }
        ...
        static int DemanderChoix(string nomJoueur)
        {
            ...
            do
            {
                Console.WriteLine(nomJoueur + " : Veuillez sélectionner un emplacement disponible");
